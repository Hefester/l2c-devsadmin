...
namespace L2.Net
{
    ...
    /// Default packer
    /// </summary>
    public class OPPacket : Packet
    {
        /// <summary>
        /// Fundamentally packet.
        /// </summary>
        /// <param name="opcode"></param>
        public OPPacket(params byte[] opcode) :base(opcode)
        {
        ...
        public OPPacket(int headerOffset, byte[] buffer): base(headerOffset, buffer)
        {
